...
TabButton.prototype.SetupHtml=function() {
	...
	this.ButtonDetach=new SpriteButton(this.button_detach_container, 12, 12, "/img/detach.png");
	this.ButtonClose=new SpriteButton(this.button_close_container, 12, 12, "/img/close.png");
...
TabButton.prototype.Select=function() {
	this.ButtonClose.Image.Set("/img/close-on.png");
	this.ButtonDetach.Image.Set("/img/detach-on.png");
	this.selected=true;
	this.UpdateHtml();
}

TabButton.prototype.Deselect=function() {
	this.ButtonClose.Image.Set("/img/close.png");
	this.ButtonDetach.Image.Set("/img/detach.png");
	this.selected=false;
	this.UpdateHtml();
}
